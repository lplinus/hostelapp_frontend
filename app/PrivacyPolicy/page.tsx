      ...
      <main className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <SectionReveal>
          <div className="bg-white p-12 rounded-3xl shadow-xl shadow-slate-200/60 max-w-xl text-center border border-slate-100">
            ...
            <p className="text-slate-500 mb-8 text-lg">The privacy policy is currently unavailable. Please try again later.</p>
            <Link 
              href="/"
        ...
        <SectionReveal>
          ...
          <article className="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            ...
            <div className="p-8 md:p-16">
                ...
                {data.effective_date && (
                  <div className="bg-slate-50 inline-block px-4 py-2 rounded-lg border border-slate-100">
                    <p className="text-sm font-semibold text-slate-500">
                      Last Updated: <span className="text-slate-900">{data.effective_date}</span>
                    </p>
                  </div>
                )}
              </header>
              ...
              <div 
                className="prose prose-slate max-w-none text-slate-600 space-y-6 whitespace-pre-line leading-relaxed text-lg"
              ...
              {(data.email || data.phone) && (
                <div className="mt-16 p-8 md:p-12 bg-slate-50 rounded-3xl border border-slate-100 relative overflow-hidden group">
                  ...
                  <h3 className="text-2xl font-bold mb-6 text-slate-900 relative">Questions about our privacy?</h3>
