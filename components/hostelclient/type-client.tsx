                    ...
                    <SheetContent side="bottom" className="h-[85vh] rounded-t-[2rem] p-0 overflow-hidden flex flex-col">
                        ...
                        <div className="overflow-y-auto flex-1 px-6 pb-28 space-y-6 pt-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    value={pendingTypeSlug}
                                    onValueChange={(value) => setPendingTypeSlug(value)}
                                >
                            ...
                            {cities.length > 1 && (
                                <div className="space-y-2">
                                    <label htmlFor="city-filter-mob" className="text-sm font-medium text-gray-700">City</label>
                                    <Select
                                        value={pendingFilters.selectedCity}
                                        onValueChange={(v) => updatePending("selectedCity", v)}
                                    >
                                        <SelectTrigger id="city-filter-mob" className="w-full bg-white h-[42px] border-gray-300 focus:ring-2 focus:ring-blue-600 rounded-md shadow-sm">
                ...
                <div className="flex flex-wrap gap-4 items-end">
                    ...
                    <div className="flex flex-col min-w-[160px] flex-1">
                        ...
                        <select
                            ...
                            value={pendingTypeSlug}
                            onChange={(e) => {
                                setPendingTypeSlug(e.target.value);
                            }}
                    ...
                    {cities.length > 1 && (
                        <div className="flex flex-col min-w-[160px] flex-1">
                            ...
                            <select
                                id="city-filter"
                                value={pendingFilters.selectedCity}
                                onChange={(e) => updatePending("selectedCity", e.target.value)}
                                className="block w-full rounded-md border-0 py-2.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-blue-600 sm:text-sm bg-white shadow-sm cursor-pointer hover:bg-gray-50 transition-colors"
                            >
                                {cities.map((city) => (
