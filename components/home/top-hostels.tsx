...
import { getTopRatedHostels } from "@/services/hostel.service";
...
export default async function TopHostels() {
  let topHostels = await getTopRatedHostels();
  ...
  // 3. Discounted
  // 4. Others
  topHostels = [...topHostels].sort((a, b) => {
  ...
  if (topHostels.length === 0) {
    return null; // hide section if no top rated hostels
  }
    ...
    <section className="py-8 sm:py-10 lg:py-12 bg-gray-50">
      <div className="max-w-[1280px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="flex items-start justify-between mb-2">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Highest rated by our users across India
            </p>
          </div>
          <Link
            href="/hostels"
        ...
        >
          ...
          {/* Carousel Slider — 4 cards per slide on large screens */}
