...
export default function RecommendedHostels({ hostels, cities }: RecommendedHostelsProps) {
    // 1. Identify cities that have at least one featured hostel
